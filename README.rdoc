...
* You want to be able to simply test the basic <tt>should be_success</tt> or <tt>should_not be_success</tt> assertions for each action and each format (atleast html and js).
  ...
  * it takes at least 10 lines of controller_spec to test just one action with two formats, ie;
    ...
    Just testing the basic responses is going to take atleast 70 lines!
