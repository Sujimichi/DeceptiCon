...
The generation of the tests is done by the +assert_mapping+ method in the DeceptiCon module which needs to be included in the spec_helper.  See Setup later for complete instructions.
